...
BEGIN
   ...
   u_21combo_proc: PROCESS(dout3, slicer)
   BEGIN
      CASE slicer IS
      WHEN "00" => dout2 <= dout3(15 DOWNTO 0);
      WHEN "01" => dout2 <= dout3(31 DOWNTO 16);
      WHEN "10" => dout2 <= dout3(47 DOWNTO 32);
      WHEN "11" => dout2 <= dout3(63 DOWNTO 48);
